...
The mapping shows:
- How each survey question relates to
...
3. Supports consistent manual and hybrid annotation
4. Enables training data creation
5. Strengthens governance and transparency
